...
optim = ng.optimizers.registry["TwoPointsDE"](parametrization, budget = 16000)
#optim3 = ng.optimizers.registry["NGOpt"](parametrization, budget = 16000)
...
plt.title("TwoPointsDE")
plt.xlabel("Iteration")
plt.ylabel("Loss")
plt.savefig("ConvTPDE.png") 
